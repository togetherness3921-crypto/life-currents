    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {!loading && !error && builds.length > 0 && (
            <ScrollArea className="max-h-[420px] overflow-y-auto pr-4">
                ...
                {builds.map((build) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center justify-between rounded-lg border bg-card px-4 py-3 shadow-sm transition hover:border-primary/50"
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          type="button"
                          onClick={() => {
                            window.location.assign(build.preview_url);
                          }}
                        >
                          View
                        </Button>
