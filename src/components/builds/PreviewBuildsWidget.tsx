              ...
              {builds.map((build) => {
                ...
                return (
                  <div
                    ...
                    className="flex flex-col gap-4 rounded-lg border bg-card px-4 py-3 text-sm shadow-sm transition hover:border-primary/50 sm:flex-row sm:items-center sm:justify-between"
                  >
                    <div className="min-w-0 space-y-1">
                      ...
                      {build.preview_url && (
                        <p className="break-all text-xs text-muted-foreground" title={build.preview_url}>
                          {build.preview_url}
                        </p>
                      )}
                    </div>
