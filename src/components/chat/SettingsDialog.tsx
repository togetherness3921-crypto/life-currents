...
const SettingsDialog: React.FC<SettingsDialogProps> = ({ open, onOpenChange }) => {
    ...
    useEffect(() => {
        if (!open || activeTab !== 'model' || hasLoadedModels) {
            return;
        }
        let isMounted = true;
    ...
    }, [open, activeTab, hasLoadedModels]);
    ...
    }, [getUsageScore, models, modelSearchTerm]);
                                        ...
                                        <div className="flex flex-col gap-2 pr-2">
                                            {filteredModels.map((model) => (
                                                <div
                                                    key={model.id}
                                                    className={cn(
                                                        'flex items-center justify-between gap-4 rounded-md border px-3 py-2 transition-colors hover:bg-muted',
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-2 whitespace-nowrap text-xs">
                                                        ...
                                                        <Toggle
                                                            pressed={isToolIntentCheckEnabled(model.id)}
                                                            onPressedChange={(pressed) =>
                                                                setToolIntentCheckEnabled(model.id, pressed)
                                                            }
