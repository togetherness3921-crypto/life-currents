  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "node-objective": "hsl(var(--node-objective))",
        "node-milestone": "hsl(var(--node-milestone))",
        "node-validation": "hsl(var(--node-validation))",
        ...
        // Graph colors
        "graph-background": "hsl(var(--graph-background))",
